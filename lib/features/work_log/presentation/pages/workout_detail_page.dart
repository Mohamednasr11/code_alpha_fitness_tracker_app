...
class WorkoutDetailPage extends StatelessWidget {
      ...
      builder: (context, state) {
        ...
        return Scaffold(
          ...
          body: current.sets.isEmpty
              ...
              : _buildSetList(
                  context, current, grouped, textPrimary, textSecondary),
      ...
      child: Column(
        ...
        children: [
          Icon(Iconsax.activity,
              size: 64, color: textSecondary.withValues(alpha: .3)),
  ...
  Widget _buildStatsRow(BuildContext context, WorkoutSession session) {
    ...
    return AnimatedListItem(
      ...
      child: Row(
        children: [
          _statChip(context, Iconsax.activity, session.sets.length.toDouble(),
              'Sets'),
          const SizedBox(width: 12),
          _statChip(context, Iconsax.weight, exercises.toDouble(), 'Exercises'),
          const SizedBox(width: 12),
          _statChip(context, Iconsax.chart_21, totalVolume, 'Volume',
              isWeight: true),
        ],
      ),
    );
  ...
  Widget _statChip(
      BuildContext context, IconData icon, double value, String label,
      {bool isWeight = false}) {
    final theme = Theme.of(context);
    return Expanded(
      child: Container(
